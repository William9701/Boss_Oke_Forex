//+------------------------------------------------------------------+
//|                                   DoubleTopBottomDetector_v2.mq5 |
//|                         Professional Double Top/Bottom Detection |
//|                                   Monthly Data - All Timeframes  |
//|                                                                  |
//| V2 Changes:                                                      |
//| - Removed arrow markers - only line and label                    |
//| - Max slope angle reduced to 2.8 degrees                         |
//+------------------------------------------------------------------+
...
//--- Input parameters - OPTIMIZED VALUES V2
...
input double MaxSlopeAngle = 2.8;          // Max slope angle in degrees (V2: reduced from 3.2)
...
int OnInit()
{
   Print("=== Double Top/Bottom Detector V2 Started ===");
...
int DetectDoubleTops()
{
   ...
   for(int i = 0; i < g_numSwingHighs; i++)
   {
      for(int j = i + 1; j < g_numSwingHighs; j++)
      {
         ...
         // V2: Only draw horizontal line and label (no arrows)
