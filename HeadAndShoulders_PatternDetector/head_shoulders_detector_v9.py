...
# Parameters - V9 WITH SHOULDER FIX
SYMBOL = "NZDUSD"
...
print(f"=== V9 Head & Shoulders Detection on {SYMBOL} (SHOULDER FIX) ===\n")
print(f"Including: ZigZag + Proper Head & Shoulder Detection\n")
print(f"V9: Head must be HIGHEST/LOWEST, but only among L-H-R candidates (not all swings)\n")
...
print("=" * 80)
print("STEP 5A: INVERSE H&S PATTERN DETECTION (V9)")
print("=" * 80)
...
print("=" * 80)
print("STEP 5B: BEARISH H&S PATTERN DETECTION (V9)")
print("=" * 80)
...
output_path = r'C:\Users\ASUS\Desktop\Boss_Oke_Forex\HeadAndShoulders_PatternDetector\head_shoulders_v9_detection.png'
plt.savefig(output_path, dpi=150, bbox_inches='tight')
print(f"\n[V9] Chart saved to: {output_path}")
