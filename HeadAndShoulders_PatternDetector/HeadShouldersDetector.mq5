//+------------------------------------------------------------------+
//|                                      HeadShouldersDetector.mq5   |
//|                                                                  |
//|  Detects Head & Shoulders and Inverse Head & Shoulders patterns |
//+------------------------------------------------------------------+
#property copyright "Head & Shoulders Pattern Detector"
#property link      ""
...
void DetectHeadAndShoulders()
{
   ...
   for(int i = 0; i < numSwingHighs - 2; i++)
   {
      ...
      DrawTrendLine(g_monthlyTime[lsIdx], neckLeft, g_monthlyTime[rsIdx], neckRight,
                    "HS_NECK_" + patternID, HSColor, STYLE_DASH);
...
void DetectInverseHeadAndShoulders()
{
   ...
   for(int i = 0; i < numSwingLows - 2; i++)
   {
      ...
      // Draw neckline (dashed)
      DrawTrendLine(g_monthlyTime[lsIdx], neckLeft, g_monthlyTime[rsIdx], neckRight,
                    "IHS_NECK_" + patternID, InvHSColor, STYLE_DASH);
