...
# Parameters - V13 WITH NEXT SHOULDER FIX
SYMBOL = "NZDUSD"
...
print(f"=== V13 Head & Shoulders Detection on {SYMBOL} (NEXT SHOULDER FIX) ===\n")
print(f"Including: ZigZag + Proper Head & Shoulder Detection\n")
print(f"V13: Right shoulder must be NEXT swing after head (not distant swings)\n")
...
print("=" * 80)
print("STEP 5A: INVERSE H&S PATTERN DETECTION (V13)")
print("=" * 80)
...
print("=" * 80)
print("STEP 5B: BEARISH H&S PATTERN DETECTION (V13)")
print("=" * 80)
...
output_path = r'C:\Users\ASUS\Desktop\Boss_Oke_Forex\HeadAndShoulders_PatternDetector\head_shoulders_v13_detection.png'
plt.savefig(output_path, dpi=150, bbox_inches='tight')
print(f"\n[V13] Chart saved to: {output_path}")
